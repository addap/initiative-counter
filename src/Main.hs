...
readAllegiance :: String -> Maybe Allegiance
...
setup window = void $ do
  ...
  let content =
        [ UI.div
          #  brow
          #+ [ element iptName # bcol 4
             , element iptInitiative # bcol 2
             , element iptAllegiance # bcol 4
             , element btnSubmit # bcol 2
             ]
        , UI.hr
        ...
        , UI.div
          #  brow
          #+ [ element btnStartCombat # bcol 4
             , element btnEndCombat # bcol 4
             , element btnNextRound # bcol 4
             , element spRound # bcol 4
             ]
